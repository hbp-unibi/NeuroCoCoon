...
import de.unibi.hbp.ncc.editor.EditorActions.ColorAction;
import de.unibi.hbp.ncc.editor.EditorActions.FontStyleAction;
import de.unibi.hbp.ncc.editor.EditorActions.HistoryAction;
import de.unibi.hbp.ncc.editor.EditorActions.KeyValueAction;
import de.unibi.hbp.ncc.editor.EditorActions.NewAction;
import de.unibi.hbp.ncc.editor.EditorActions.OpenAction;
import de.unibi.hbp.ncc.editor.EditorActions.PrintAction;
...
public class EditorToolBar extends JToolBar
{
	...
	public EditorToolBar(final BasicGraphEditor editor, int orientation)
	{
		...
		add(editor.bind("Print", new PrintAction(),
				"/de/unibi/hbp/ncc/images/print.gif"));

		add(editor.bind("Run", new RunAction() /*, "/de/unibi/hbp/ncc/images/run.gif" */));
		addSeparator();
		...
		add(editor.bind("Bold", new FontStyleAction(true),
				"/de/unibi/hbp/ncc/images/bold.gif"));
		add(editor.bind("Italic", new FontStyleAction(false),
				"/de/unibi/hbp/ncc/images/italic.gif"));
