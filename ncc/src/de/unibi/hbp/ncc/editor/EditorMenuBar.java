...
public class EditorMenuBar extends JMenuBar
{
	...
	public EditorMenuBar(final BasicGraphEditor editor)
	{
		...
		menu.add(editor.bind(mxResources.get("save"), new SaveAction(false), "/de/unibi/hbp/ncc/images/save.gif"));
		menu.add(editor.bind(mxResources.get("saveAs"), new SaveAction(true), "/de/unibi/hbp/ncc/images/saveas.gif"));

		menu.addSeparator();

		menu.add(editor.bind(mxResources.get("pageSetup"), new PageSetupAction(), "/de/unibi/hbp/ncc/images/pagesetup.gif"));
		menu.add(editor.bind(mxResources.get("print"), new PrintAction(), "/de/unibi/hbp/ncc/images/print.gif"));
		...
		menu.add(editor.bind(mxResources.get("undo"), new HistoryAction(true), "/de/unibi/hbp/ncc/images/undo.gif"));
		menu.add(editor.bind(mxResources.get("redo"), new HistoryAction(false), "/de/unibi/hbp/ncc/images/redo.gif"));

		menu.addSeparator();

		menu.add(editor.bind(mxResources.get("cut"), TransferHandler.getCutAction(), "/de/unibi/hbp/ncc/images/cut.gif"));
		menu.add(editor.bind(mxResources.get("copy"), TransferHandler.getCopyAction(), "/de/unibi/hbp/ncc/images/copy.gif"));
		menu.add(editor.bind(mxResources.get("paste"), TransferHandler.getPasteAction(), "/de/unibi/hbp/ncc/images/paste.gif"));

		menu.addSeparator();

		menu.add(editor.bind(mxResources.get("delete"), mxGraphActions.getDeleteAction(), "/de/unibi/hbp/ncc/images/delete.gif"));
	...
	{
		menu.add(editor.bind(mxResources.get("home"), mxGraphActions.getHomeAction(), "/de/unibi/hbp/ncc/images/house.gif"));

		menu.addSeparator();

		menu.add(editor.bind(mxResources.get("exitGroup"), mxGraphActions.getExitGroupAction(), "/de/unibi/hbp/ncc/images/up.gif"));
		menu.add(editor.bind(mxResources.get("enterGroup"), mxGraphActions.getEnterGroupAction(),
				"/de/unibi/hbp/ncc/images/down.gif"));

		menu.addSeparator();

		menu.add(editor.bind(mxResources.get("group"), mxGraphActions.getGroupAction(), "/de/unibi/hbp/ncc/images/group.gif"));
		menu.add(editor.bind(mxResources.get("ungroup"), mxGraphActions.getUngroupAction(),
				"/de/unibi/hbp/ncc/images/ungroup.gif"));
		...
		menu.add(editor.bind(mxResources.get("collapse"), mxGraphActions.getCollapseAction(),
				"/de/unibi/hbp/ncc/images/collapse.gif"));
		menu.add(editor.bind(mxResources.get("expand"), mxGraphActions.getExpandAction(), "/de/unibi/hbp/ncc/images/expand.gif"));

		menu.addSeparator();

		menu.add(editor.bind(mxResources.get("toBack"), mxGraphActions.getToBackAction(), "/de/unibi/hbp/ncc/images/toback.gif"));
		menu.add(editor.bind(mxResources.get("toFront"), mxGraphActions.getToFrontAction(),
				"/de/unibi/hbp/ncc/images/tofront.gif"));
	...
	public static void populateFormatMenu(JMenu menu, BasicGraphEditor editor)
	{
		...
		submenu.add(editor.bind(mxResources.get("fillcolor"), new ColorAction("Fillcolor", mxConstants.STYLE_FILLCOLOR),
				"/de/unibi/hbp/ncc/images/fillcolor.gif"));
		...
		submenu.add(editor.bind(mxResources.get("fontcolor"), new ColorAction("Fontcolor", mxConstants.STYLE_FONTCOLOR),
				"/de/unibi/hbp/ncc/images/fontcolor.gif"));
		...
		submenu.add(editor.bind(mxResources.get("linecolor"), new ColorAction("Linecolor", mxConstants.STYLE_STROKECOLOR),
				"/de/unibi/hbp/ncc/images/linecolor.gif"));
		...
		submenu.add(editor.bind(mxResources.get("straight"), new SetStyleAction("straight"),
				"/de/unibi/hbp/ncc/images/straight.gif"));

		submenu.add(editor.bind(mxResources.get("horizontal"), new SetStyleAction(""), "/de/unibi/hbp/ncc/images/connect.gif"));
		submenu.add(editor.bind(mxResources.get("vertical"), new SetStyleAction("vertical"),
				"/de/unibi/hbp/ncc/images/vertical.gif"));

		submenu.addSeparator();

		submenu.add(editor.bind(mxResources.get("entityRelation"), new SetStyleAction("edgeStyle=mxEdgeStyle.EntityRelation"),
				"/de/unibi/hbp/ncc/images/entity.gif"));
		submenu.add(editor.bind(mxResources.get("arrow"), new SetStyleAction("arrow"), "/de/unibi/hbp/ncc/images/arrow.gif"));
		...
		submenu.add(editor.bind(mxResources.get("open"), new KeyValueAction(mxConstants.STYLE_STARTARROW, mxConstants.ARROW_OPEN),
				"/de/unibi/hbp/ncc/images/open_start.gif"));
		...
		submenu.add(editor.bind(mxResources.get("middle"), new KeyValueAction(mxConstants.STYLE_VERTICAL_ALIGN, mxConstants.ALIGN_MIDDLE),
				"/de/unibi/hbp/ncc/images/middle.gif"));
		submenu.add(editor.bind(mxResources.get("bottom"), new KeyValueAction(mxConstants.STYLE_VERTICAL_ALIGN, mxConstants.ALIGN_BOTTOM),
				"/de/unibi/hbp/ncc/images/bottom.gif"));
